#include "simulator/weapon_sim.hpp"

Weapon_sim::Weapon_sim(Sim_time swing_speed, double min_damage, double max_damage, Socket socket,
                       Weapon_type skill_type, Weapon_socket weapon_socket, std::vector<Hit_effect> hit_effects)
    : swing_speed{swing_speed}
    , internal_swing_timer{Sim_time::zero()}
