...
struct Armory
{
    ...
    struct shoulder_t
    {
        Armor black_dragonscale_shoulders{Stats{0, 0}, Special_stats{0, 0, 40}, Armor::Socket::shoulder,
    ...
    struct wrists_t
    {
        ...
        Armor wristhuards_of_true_flight{Stats{0, 19}, Special_stats{0, 1, 0}, Armor::Socket::wrists};
        Armor battleborn_armbraces{Stats{0, 0}, Special_stats{1, 1, 0}, Armor::Socket::wrists};
    } wrist;

    struct hands_t
    {
        Armor devilsaur_gauntlets{Stats{0, 0}, Special_stats{1, 0, 28}, Armor::Socket::hands, Set_name::devilsaur};
    ...
    struct legs_t
    {
        Armor devilsaur_leggings{Stats{0, 0}, Special_stats{1, 0, 46}, Armor::Socket::legs, Set_name::devilsaur};
    ...
    struct boots_t
    {
        ...
        Armor black_dragonscale_boots{Stats{0, 0}, Special_stats{0, 0, 28}, Armor::Socket::boots,
                                      Set_name::black_dragonscale};
    ...
    struct swords_t
    {
        ...
        Weapon chromatically_tempered_sword = Weapon{2.6, {106.0, 198.0}, Stats{14.0, 14.0},
                                                     Special_stats{0.0, 0.0, 0.0},
                                                     Weapon::Socket::one_hand, Skill_type::sword};

        Weapon brutality_blade{2.5, {90, 168}, Stats{9, 9}, Special_stats{1, 0, 0}, Weapon::Socket::one_hand,
                               Skill_type::sword};
        Weapon assassination_blade{2.7, {71, 132}, Stats{3, 0}, Special_stats{1, 0, 0}, Weapon::Socket::one_hand,
                                   Skill_type::sword};
        Weapon mirahs_song{1.8, {57, 87}, Stats{9, 9}, Special_stats{0, 0, 0}, Weapon::Socket::one_hand,
                           Skill_type::sword};
        Weapon viskag{2.6, {100, 187}, Stats{0, 0}, Special_stats{0, 0, 0}, Weapon::Socket::one_hand,
                      Skill_type::sword};
    } swords;
    ...
    {
        Set_bonus devilsaur_set_bonus{Stats{0, 0}, Special_stats{0, 2, 0}, 2, Set_name::devilsaur};
        Set_bonus black_dragonscale_bonus2{Stats{0, 0}, Special_stats{0, 1, 0}, 2, Set_name::black_dragonscale};
        Set_bonus black_dragonscale_bonus3{Stats{0, 0}, Special_stats{2, 0, 0}, 3, Set_name::black_dragonscale};
        Set_bonus rare_pvp_set_bonus_1{Stats{0, 0}, Special_stats{0, 0, 40}, 2, Set_name::rare_pvp_set};
    } set_bonuses;
