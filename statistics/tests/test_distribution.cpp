...
TEST(TestSuite, test_distribution)
{
    ...
    ASSERT_DOUBLE_EQ(distribution.max_, 9);
    ASSERT_DOUBLE_EQ(distribution.min_, 1);
...
//TEST(TestSuite, test_distribution_is_normal)
//{
//    std::default_random_engine generator{};
//    std::normal_distribution<double> nd(5.0, 2.0);
//    int n_namples = 1000000;
//    //    double p_value = 0.99;
//    Distribution distribution{};
//    distribution.add_sample(3);
//    distribution.add_sample(4);
//    distribution.add_sample(5);
//    EXPECT_TRUE(!distribution.is_normal_distributed());
//
//    for (int i = 0; i < n_namples; ++i)
//    {
//        double number = nd(generator);
